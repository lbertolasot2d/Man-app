...
import { importObject, setWasmExports } from './Man-app-composeApp.import-object.mjs'
...
const wasmFilePath = './Man-app-composeApp.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./Man-app-composeApp.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
